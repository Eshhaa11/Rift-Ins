...
function About () {
  return (
    <div className="about">
      ...
      <p>Rift Nakuru Insurance Agencies Limited is a registered Insurance Agency < br/>
      managed by qualified & highly experienced personnel commited to < br/>
      providing outstanding level of international standard service to our < br/>
